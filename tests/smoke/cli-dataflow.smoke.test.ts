...
describe.if(serverAvailable)(
  ...
  () => {
    ...
    beforeAll(async () => {
      ...
      // for pull. Seed alice as a real user row (FK target for repo_roles)
      // with admin on the repo this test exercises, since
      // DELTIX_LOCAL_USERS carries no repo roles.
